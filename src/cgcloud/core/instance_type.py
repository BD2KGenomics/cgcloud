...
_ec2_instance_types = [
    ...
    IT( name='d2.xlarge', cores='4', ecu='14', memory='30.5', disks=3, disk_type='SSD', disk_capacity=2000 ),
    IT( name='d2.2xlarge', cores='8', ecu='28', memory='61', disks=6, disk_type='SSD', disk_capacity=2000 ),
    IT( name='d2.4xlarge', cores='16', ecu='56', memory='122', disks=12, disk_type='SSD', disk_capacity=2000 ),
    IT( name='d2.8xlarge', cores='36', ecu='116', memory='244', disks=24, disk_type='SSD', disk_capacity=2000 ),
    # previous generation instance types
    IT( name='m1.small', cores='1', ecu='1', memory='1.7', disks=1, disk_type='SSD', disk_capacity=160 ),
    IT( name='m1.medium', cores='1', ecu='2', memory='3.75', disks=1, disk_type='SSD', disk_capacity=410 ),
    IT( name='m1.large', cores='2', ecu='4', memory='7.5', disks=2, disk_type='SSD', disk_capacity=420 ),
    IT( name='m1.xlarge', cores='4', ecu='8', memory='15', disks=4, disk_type='SSD', disk_capacity=420 ),
    IT( name='c1.medium', cores='2', ecu='5', memory='1.7', disks=1, disk_type='SSD', disk_capacity=350 ),
    IT( name='c1.xlarge', cores='8', ecu='20', memory='7', disks=4, disk_type='SSD', disk_capacity=420 ),
    IT( name='cc2.8xlarge', cores='32', ecu='88', memory='60.5', disks=4, disk_type='SSD', disk_capacity=840 ),
    IT( name='m2.xlarge', cores='2', ecu='6.5', memory='17.1', disks=1, disk_type='SSD', disk_capacity=420 ),
    IT( name='m2.2xlarge', cores='4', ecu='13', memory='34.2', disks=1, disk_type='SSD', disk_capacity=850 ),
    IT( name='m2.4xlarge', cores='8', ecu='26', memory='68.4', disks=2, disk_type='SSD', disk_capacity=840 ),
    ...
    IT( name='hs1.8xlarge', cores='16', ecu='35', memory='117', disks=24, disk_type='SSD', disk_capacity=2048 ),
